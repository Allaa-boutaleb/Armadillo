...
def visualize_scatter_plot(exp_data_file: str | dict, logx: bool=True, logy: bool=True, out_pdf: str=None, font_size: int=10) -> None:
    ...
    ax_scatter.set_ylabel('Total Embedding Time (s)', fontsize=font_size)
