...
def table_querying(t_query: str, target_set: set, model: Armadillo, table_dict: dict, target_embedding_tensor: dict, index_to_table_mapping: dict) -> dict:
    ...
    Args:
        ...
        model (Armadillo): model file to initialize armadillo
...
def run_table_querying_experiment(query_set: set | str, target_set: set | str, model: Armadillo | str, target_embedding_dict: dict | str=None, table_dict: dict | str=None, outpath: str=None) -> None:
    ...
    Args:
        ...
        model (Armadillo | str): model to generate the emebddings
    ...
    if isinstance(model, str):
        model = Armadillo(model_file=model)
