...
def evaluate(model_GitTables: str, table_dict_GitTables: str | dict, model_WikiLast: str, table_dict_WikiLast: str | dict, 
    ...
    add_armadillo_predictions_to_sloth_file(sloth_baseline_out=root_gittables+'gittables_root/table_querying.csv', armadillo_out=chart_data_path+'/table_querying_arm.pkl', outpath=chart_data_path+'/armadillo_sloth_table_querying_enriched.csv')
