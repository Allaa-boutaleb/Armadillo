...
from _revision_ablation_study.cell_column_aggregation.armadillo import Armadillo
...
def embed_all(graph_dict: dict|str, model_path: str, batch_size: int=64, to_cpu: bool=False, num_workers: int=0) -> dict:
    ...
    with torch.no_grad():
        for batch in tqdm(loader):
            embeddings = model(batch[0].to(device), batch[2], batch[3], batch[4])
...
if __name__ == '__main__':
    root_ablation = '/home/francesco.pugnaloni/armadillo_all/ablation_study/cell_column_aggreg/'
