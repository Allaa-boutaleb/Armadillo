...
if __name__ == '__main__':
    ...
    """
    root_ablation = '/home/francesco.pugnaloni/armadillo_all/ablation_study/cell_column_aggreg/' #'/home/francesco.pugnaloni/armadillo_all/ablation_study/random_emb/' 
    ...
    model_out = root_ablation+'/models/armadillo_repeated.pth'          # Insert here the full name of the model checkpoint, e.g., root/gittables_root/models/armadillo_git.pth
