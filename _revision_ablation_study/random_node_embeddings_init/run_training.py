...
from _revision_ablation_study.random_node_embeddings_init._generate_graph_dict import *
from _revision_ablation_study.random_node_embeddings_init._training_pipeline import *
import time
import os
...
if __name__ == '__main__':
    ...
    """
    root_ablation = '/home/francesco.pugnaloni/armadillo_all/ablation_study/random_emb/'
    ...
    try:
        ...
        # Write in a txt file the time needed to generate the graph_dict, save the file inside the root_dataset and call it graph_dict_gen_time.txt
    ...
    # Write in a txt file the time needed to train the model, save the file inside the root_dataset and call it train_time.txt
