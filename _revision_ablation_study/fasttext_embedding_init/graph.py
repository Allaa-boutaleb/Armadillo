...
import math
from _revision_ablation_study.fasttext_embedding_init.node_embeddings import *
...
class Graph:
    ...
    def __init__(self,  df: pd.DataFrame, table_name: str, embedding_buffer_type: str='fasttext', embedding_buffer: Embedding_buffer=None, preprocess_string_token: String_token_preprocessor=None,  
