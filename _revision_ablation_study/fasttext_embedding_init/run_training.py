...
from _revision_ablation_study.fasttext_embedding_init._training_pipeline import run_Armadillo_experiment_split
...
def retrain_model(model_out_path: str, train_file: str, test_file: str, valid_file: str, graph_dict: str | dict) -> None:
    ...
    initial_embedding_method = 'fasttext'
...
if __name__ == '__main__':
    ...
    """
    root_ablation = '/home/francesco.pugnaloni/armadillo_all/ablation_study/fasttext/' #'/home/francesco.pugnaloni/armadillo_all/ablation_study/random_emb/' 
