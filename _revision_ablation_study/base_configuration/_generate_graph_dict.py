...
def generate_graph_dictionary(table_dict_path: str | dict, out_path: str=None, embedding_generation_method: str='sha256', save_graph_dict: bool=True, limit: int=None) -> dict:
